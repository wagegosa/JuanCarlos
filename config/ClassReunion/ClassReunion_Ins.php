...
if ($_POST != "" ){
  try{
    ...
    $query = "INSERT INTO Juancarloso.tba_reunion(fec_reunio_inicio, hor_inicio, hor_finxxx, direccion, organizador,  telefono, barrio, localidad, fec_creacio, fec_modifi, activo) VALUES ('$fec_reunion',  '$hor_reunio', '$ho_finxxx', '$direccion', '$organizador', '$telefono', '$barrio', '$localidad',  now(), now(), '$activo')";
