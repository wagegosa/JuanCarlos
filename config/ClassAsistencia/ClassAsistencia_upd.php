...
if($_POST != "" ){
  try{
    ...
    $query = "UPDATE Juancarloso.tba_regist_asiste SET cedula= '$num_cedula', nom_comple= '$nombre', telefono= '$telefono', correo= '$email', dir_reside= '$direccion', lugar_votacio= '$lugar_votacio', usuario= '1',  organizador= '$organizador', fec_modifi= '$hoy' WHERE idtba_regist_asiste = $id";
