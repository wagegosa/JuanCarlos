...
if($_POST != "" ){
  try{
    ...
    $query = "UPDATE Juancarloso.tba_regist_empresa SET cedula= '$num_cedula', nom_comple= '$nombre', telefono= '$telefono', correo= '$email', dir_reside= '$direccion', localida= '$localidad', lugar_votacio= '$lugar_votacio', usuario= '1',  organizador= '$organizador', empresa= '$empresa', fec_modifi= '$hoy' WHERE idtba_regist_asiste = $id";
