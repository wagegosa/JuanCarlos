...
<body>
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        <h3 class="page-header"><span class="glyphicons glyphicons-group"></span> Agenda</h3>
        <ol class="breadcrumb">
          <li><a href="">Inicio</a></li>
          <li><a href="index.php">Agenda</a></li>
          <li class="active">Nueva Agenda</li>
        </ol>
      </div>
    </div>
    <!-- Formulario -->
    <form method="post" autocomplete="on" id="frm" action="../../config/ClassReunion/ClassReunion_Ins.php">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <input type="date" class="form-control" name="fec_reunion" rows="5" id="fec_reunion" can_asis value="<?= date('Y-m-d');?>" placeholder="Fecha reunión" >
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <input type="time" class="form-control" name="hor_reunio" id="hor_reunio" required placeholder="Hora Reunión">
          <span class="help-block" id="error"></span>
        </div>
      </div>
      <!-- Hora Fin -->
      <div class="row">
        ...
        <div class="col-md-8">
          <input type="time" class="form-control" name="ho_finxxx" id="ho_finxxx" required placeholder="Hora finalización">
          <span class="help-block" id="error"></span>
        </div>
      </div>
      <!-- organizador -->
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <input type="text" class="form-control" name="barrio" id="barrio" required placeholder="Barrio">
          <span class="help-block" id="error"></span>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <input type="enum" class="form-control" name="can_asis" id="can_asis" required placeholder="Cantidad de asistentes">
          <span class="help-block" id="error"></span>
        </div>
      </div>
      <!-- activo -->
