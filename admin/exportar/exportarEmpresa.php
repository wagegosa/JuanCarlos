...
if ($fecha_inicial != "" || $fecha_inicial != null){
    ...
    $query = "SELECT idtba_regist_asiste, cedula, nom_comple, telefono, correo, dir_reside, localidad, Lug_votaci, empresa, USER, organizador, fec_creaci FROM juancarlos.vs_exp_empresa WHERE CONVERT(fec_creaci, DATE)  = '$fecha_inicial'";
	// echo "<pre>";
	// print_r($queryR);
	// echo "</pre>";
	// die();
