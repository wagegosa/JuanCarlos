...
$query = "SELECT idtba_regist_asiste, cedula, nom_comple, telefono, correo, dir_reside, localida, lugar_votacio, usuario, organizador, CONVERT(fec_creaci, DATE) AS fec_creaci FROM gloriadiaz.tba_regist_asiste";
...
while ($row=mysqli_fetch_assoc($result)):
  $objPHPExcel->setActiveSheetIndex(0)
  ->setCellValue('A'.$c, $row['idtba_regist_asiste'])
  ...
  ->setCellValue('G'.$c, $row['localida'])
  ->setCellValue('H'.$c, $row['lugar_votacio'])
