...
$query = "SELECT idtba_regist_asiste, cedula, nom_comple, telefono, correo, dir_reside, localidad, Lug_votaci, empresa, USER, organizador, CONVERT(fec_creaci, DATE) AS fec_creaci FROM juancarlos.vs_exp_empresa ";
